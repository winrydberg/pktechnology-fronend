    ...
    <div class="container-fluid" >
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">My Pending Orders</li>
        </ol>
      </section>
...
<!--        </div>-->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="box box-info box-height" >
              <div class="box-header with-border">
                <h3 class="box-title">Your Pending Working Orders</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <div class="col-md-12 d-flex justify-content-center align-items-center flex-column alert alert-info">
                  <i class="fa fa-info-circle"></i>
                  <strong class="align-self-center">Your Pending Working Orders Will Appear Here</strong>
                </div>
